             ...
             <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <!-- Título Ministerial -->
                 <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $user->title) }}" placeholder="Ex: Pastor, Missionário"
                           class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <!-- Formação Teológica -->
                 <div>
                    ...
                    <input type="text" name="theological_education" id="theological_education" value="{{ old('theological_education', $user->theological_education) }}" placeholder="Ex: Bacharel"
                           class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <!-- Data Ordenação -->
                 <div>
                ...
                <!-- Igreja Afiliada -->
                 <div>
                    ...
                    <input type="text" name="affiliated_church" id="affiliated_church" value="{{ old('affiliated_church', $user->affiliated_church) }}"
                           class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <!-- Convenção -->
                 <div>
                    ...
                    <input type="text" name="baptist_convention" id="baptist_convention" value="{{ old('baptist_convention', $user->baptist_convention) }}"
                           class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                </div>
                <!-- É Batizado? -->
                 <div>
                ...
                <!-- Ordenado? -->
                 <div>
                    ...
                    <select name="is_ordained" id="is_ordained"
                        class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                        <option value="1" {{ old('is_ordained', $user->is_ordained) == '1' ? 'selected' : '' }}>Sim</option>
                        <option value="0" {{ old('is_ordained', $user->is_ordained) == '0' ? 'selected' : '' }}>Não</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2 lg:col-span-3">
                    ...
                    <textarea name="biography" id="biography" rows="3"
                              class="w-full rounded-xl border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">{{ old('biography', $user->biography) }}</textarea>
                </div>
             </div>
        </div>
