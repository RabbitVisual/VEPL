...
<aside id="sidebar"
    ...
    x-data="{
        ...
        bibleToolsOpen: {{ (request()->routeIs('admin.bible.metadata*') || request()->routeIs('admin.bible.strongs*') || request()->routeIs('admin.bible.panoramas*') || request()->routeIs('admin.bible.word-tags*')) ? 'true' : 'false' }},
    }">
            ...
            <div class="space-y-1">
                ...
                <div x-show="bibleOpen" style="display: none;">
                    <div class="pl-12 pr-4 space-y-1 mt-1">
                        ...
                        <!-- Estúdio Teológico Sub-Collapsible -->
                        <div class="pt-2">
                            <button @click="bibleToolsOpen = !bibleToolsOpen"
                                ...
                                <span>Estúdio Teológico (Bíblia)</span>
                            ...
                            <div x-show="bibleToolsOpen" x-collapse class="space-y-1 mt-1 border-l border-gray-100 dark:border-gray-800 ml-2 shadow-inner">
                                <a href="{{ route('admin.bible.metadata.index') }}" class="flex items-center gap-2 px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ request()->routeIs('admin.bible.metadata.*') ? 'text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10' : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300' }}">
                                ...
                                <a href="{{ route('admin.bible.strongs-lexicon.index') }}" class="flex items-center gap-2 px-3 py-2 text-xs font-medium rounded-lg transition-colors {{ request()->routeIs('admin.bible.strongs-lexicon.*') ? 'text-blue-600 dark:text-blue-400 bg-blue-50/50 dark:bg-blue-900/10' : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-300' }}">
                                    <x-icon name="language" style="duotone" class="w-3.5 h-3.5 shrink-0" />
                                    Dicionário Original (Strong)
                                </a>
