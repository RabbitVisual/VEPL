...
@section('title', 'Ver Word Tag #'.$entry->id)

@section('content')
    <div class="p-6 space-y-6">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Word Tag #{{ $entry->id }}</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Verse: <span class="font-mono">{{ $entry->verse_id }}</span> · Pos: <span class="font-mono">{{ $entry->position }}</span></p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-6 space-y-5">
                <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-4">
                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Word surface</p>
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-4">
                        <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Lang</p>
                        <p class="text-sm text-gray-700 dark:text-gray-200">{{ $entry->lang }}</p>
                    </div>
                </div>
                <div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/30 p-4">
                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Morphology</p>
