...
@section('title', 'Editar Panorama')

@section('content')
    <div class="p-6 space-y-6">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white tracking-tight">Editar Panorama (Livro {{ $entry->book_number }})</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-2">Atualize metadados permitidos.</p>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <form action="{{ route('admin.bible.panoramas.update', $entry->id) }}" method="POST" class="p-6 space-y-6">
                @csrf
                @method('PUT')
