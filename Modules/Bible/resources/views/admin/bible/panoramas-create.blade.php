            ...
            <form action="{{ route('admin.bible.panoramas.store') }}" method="POST" class="p-6 space-y-6">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="testament" required
                                class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-600 focus:border-amber-600 dark:bg-gray-700 dark:text-white transition-colors">
                            <option value="old" {{ old('testament')==='old'?'selected':'' }}>Antigo</option>
                            <option value="new" {{ old('testament')==='new'?'selected':'' }}>Novo</option>
                        </select>
                ...
                <div>
                    ...
                    <textarea name="theme_central" rows="4"
                              class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-600 focus:border-amber-600 dark:bg-gray-700 dark:text-white transition-colors resize-none">{{ old('theme_central') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="recipients" rows="4"
                              class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-amber-600 focus:border-amber-600 dark:bg-gray-700 dark:text-white transition-colors resize-none">{{ old('recipients') }}</textarea>
